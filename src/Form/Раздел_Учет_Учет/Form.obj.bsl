...
Процедура НастроитьКолонки(Кэш) Экспорт
	//СтатусВГосСистеме
	ПутьРеквизит = "Таблица_РеестрДокументов." + ?(Кэш.ПараметрыСистемы.Клиент.УправляемоеПриложение, "Таблица_РеестрДокументов", "");
	Кэш.ГлавноеОкно.СбисПолучитьЭлементФормы(Кэш.ГлавноеОкно, ПутьРеквизит + "ТекущийЭтап").Видимость = Истина;
	Кэш.ГлавноеОкно.СбисПолучитьЭлементФормы(Кэш.ГлавноеОкно, ПутьРеквизит + "СтатусВГосСистеме").Видимость = Кэш.Парам.СтатусыВГосСистеме;	 	
